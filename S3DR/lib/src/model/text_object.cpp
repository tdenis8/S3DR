...
TextObject::TextObject(SceneObject * parent, std::string name, int priority):
...
void TextObject::AppendData(const std::vector<glm::vec3> & vertices,
...
const LineData & TextObject::LineDataRef(){
    return line_data;
}