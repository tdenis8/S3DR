...
std::vector<Shader> PointRenderer::GetShaderList()
{
   ...
   shader_list.push_back(Shader(point_object_VS_vert, GL_VERTEX_SHADER, "point_object_VS"));
   shader_list.push_back(Shader(point_object_FS_frag, GL_FRAGMENT_SHADER, "point_object_FS"));
   return shader_list;
}
