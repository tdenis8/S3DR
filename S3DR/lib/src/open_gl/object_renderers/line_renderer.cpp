...
std::vector<Shader> LineRenderer::GetShaderList()
{
   ...
   shader_list.push_back(Shader(line_object_VS_vert, GL_VERTEX_SHADER, "line_object_VS"));
   shader_list.push_back(Shader(line_object_FS_frag, GL_FRAGMENT_SHADER, "line_object_FS"));
   return shader_list;
}
